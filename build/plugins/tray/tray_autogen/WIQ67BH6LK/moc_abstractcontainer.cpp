...
void AbstractContainer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AbstractContainer *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (AbstractContainer::*)(FashionTrayWidgetWrapper * , const bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractContainer::attentionChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AbstractContainer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractContainer::requestDraggingWrapper)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AbstractContainer::*)(FashionTrayWidgetWrapper * , const bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractContainer::draggingStateChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AbstractContainer::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_AbstractContainer.data,
    qt_meta_data_AbstractContainer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
