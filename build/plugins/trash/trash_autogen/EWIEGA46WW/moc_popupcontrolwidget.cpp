...
void PopupControlWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PopupControlWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (PopupControlWidget::*)(const bool ) const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PopupControlWidget::emptyChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PopupControlWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_PopupControlWidget.data,
    qt_meta_data_PopupControlWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
