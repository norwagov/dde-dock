...
void XEmbedTrayWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<XEmbedTrayWidget *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject XEmbedTrayWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractTrayWidget::staticMetaObject>(),
    qt_meta_stringdata_XEmbedTrayWidget.data,
    qt_meta_data_XEmbedTrayWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
