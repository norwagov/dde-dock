...
void PowerStatusWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PowerStatusWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (PowerStatusWidget::*)(const QString & ) const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PowerStatusWidget::requestContextMenu)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PowerStatusWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_PowerStatusWidget.data,
    qt_meta_data_PowerStatusWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
