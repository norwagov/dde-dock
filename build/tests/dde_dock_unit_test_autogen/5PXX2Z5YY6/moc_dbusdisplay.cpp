...
void DBusDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DBusDisplay *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (DBusDisplay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBusDisplay::BrightnessChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DBusDisplay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBusDisplay::BuiltinOutputChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (DBusDisplay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBusDisplay::DisplayModeChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (DBusDisplay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBusDisplay::HasChangedChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (DBusDisplay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBusDisplay::MonitorsChanged)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (DBusDisplay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBusDisplay::PrimaryChanged)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (DBusDisplay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBusDisplay::PrimaryRectChanged)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (DBusDisplay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBusDisplay::ScreenHeightChanged)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (DBusDisplay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBusDisplay::ScreenWidthChanged)) {
                *result = 8;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DBusDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<QDBusAbstractInterface::staticMetaObject>(),
    qt_meta_stringdata_DBusDisplay.data,
    qt_meta_data_DBusDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
