...
void SystemTraysController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SystemTraysController *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SystemTraysController::*)(const QString & , AbstractTrayWidget * ) const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemTraysController::pluginItemAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SystemTraysController::*)(const QString & , AbstractTrayWidget * ) const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemTraysController::pluginItemRemoved)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SystemTraysController::*)(const QString & , AbstractTrayWidget * ) const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemTraysController::pluginItemUpdated)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SystemTraysController::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractPluginsController::staticMetaObject>(),
    qt_meta_stringdata_SystemTraysController.data,
    qt_meta_data_SystemTraysController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
