...
void DBusClientManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DBusClientManager *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (DBusClientManager::*)(uint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBusClientManager::ActiveWindowChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DBusClientManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QDBusAbstractInterface::staticMetaObject>(),
    qt_meta_stringdata_DBusClientManager.data,
    qt_meta_data_DBusClientManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
