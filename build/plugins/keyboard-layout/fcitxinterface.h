 ...
 * Command line was: qdbusxml2cpp -m -c FcitxInputMethodProxy -i fcitxinputmethoditem.h -p fcitxinterface /home/norwagovmain/Documents/Desktop-Environment/dde-dock/plugins/keyboard-layout/org.fcitx.Fcitx.xml
 *
...
#ifndef FCITXINTERFACE_H
#define FCITXINTERFACE_H
 ...
 */
class FcitxInputMethodProxy: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    FcitxInputMethodProxy(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<QString> GetIMByIndex(int index)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(index);
        return asyncCallWithArgumentList(QStringLiteral("GetIMByIndex"), argumentList);
    }
    ...
    inline QDBusPendingReply<> SwitchIM()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QStringLiteral("SwitchIM"), argumentList);
    }
...
namespace org {
  namespace fcitx {
    namespace Fcitx {
      typedef ::FcitxInputMethodProxy InputMethod;
    }
  }
}
#endif
