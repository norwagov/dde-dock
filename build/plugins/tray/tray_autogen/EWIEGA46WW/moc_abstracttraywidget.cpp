...
void AbstractTrayWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AbstractTrayWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (AbstractTrayWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractTrayWidget::iconChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AbstractTrayWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractTrayWidget::clicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AbstractTrayWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractTrayWidget::needAttention)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (AbstractTrayWidget::*)(const bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractTrayWidget::requestWindowAutoHide)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (AbstractTrayWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractTrayWidget::requestRefershWindowVisible)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AbstractTrayWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_AbstractTrayWidget.data,
    qt_meta_data_AbstractTrayWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
